...
//                    log.info("Init driver: browser window size = " + windowSize);
//                }
//                return driver;
//            } catch (Exception ex) {
//                log.error("Failed initialized webdriver: retry" + i + ":" + ex.getMessage());
...
//            }
//        } catch (Exception e) {
//            log.error("Error closing driver. You may need to clean up execution machine. error: " + e);
//        }
//        driver = null;
//    }
//
...
//        try {
//            if (RunConfig.closeBrowserAtExit && (quit || RunConfig.useSauceLabs)) {
//                driver.quit();
//                log.info("webdriver quit successful");
//                if (ie()) {
//                    // workaround for IE browser not closing the first time
//                    driver.quit();
//                    log.info("webdriver quit successful for ie");
//                }
//
//            }
//        } catch (Exception e) {
//            log.warn("Driver could not be reset. See debug log for details");
